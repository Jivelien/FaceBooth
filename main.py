...
from photo_generator_lib.gui.tkinter_gui import TkinterGui
...
if __name__ == "__main__":
    ...
    gui = TkinterGui(dreambooth=dreambooth, prompt_generator=prompt_generator, seed_generator=seed_generator)
    gui.mainloop()
